    ...
    return (
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <ImageBackground
            source={require("../../assets/Product/DriverMotor.png")}
          ...
          <View style={{ height: 205, width: "100%", padding: 15 }}>
            ...
            <Text style={styles.productHeadCount}>
              L298N is a high voltage, high current motor driver chip. The chip
              uses 15-pin package. The main features are: high voltage, maximum
              operating voltage up to 46V; output current, instantaneous peak
              current up to 3A, continuous operating current of 2A; rated power
              25W.
            </Text>
          </View>
        </ScrollView>
