    ...
    return (
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <ImageBackground
            source={require("../../assets/Product/ArduinoNano.png")}
          ...
          <View style={{ height: 205, width: "100%", padding: 15 }}>
            ...
            <Text style={styles.productHeadCount}>
              This Arduino Nano ATmega328P CH340G is a small, complete, and
              breadboard-friendly board based on the ATmega328. It is fully
              compatible with the official Arduino board.
            </Text>
          </View>
        </ScrollView>
        <View
