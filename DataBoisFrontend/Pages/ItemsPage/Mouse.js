...
export default class Earphone extends Component{
    constructor(props){
        super(props);
        this.state={
            ProductName:"G604 LIGHTSPEED WIRELESS GAMING MOUSE",
            ActualPrice: 4999,
            Price:"P 4999",
        }
    }
        ...
        return(
            <View style={styles.container}>
                <ScrollView showsVerticalScrollIndicator={false}>
                    <ImageBackground source={require("../../assets/Product/Mouse.png")} style={{height: 400, width: "100%"}}>
                    ...
                    <View style={{height: 205, width:"100%",padding: 15,}}>
                        ...
                        <Text style={styles.productHeadCount}>Your power, your control. Conquer MOBA, MMO, and Battle Royale gameplay with the strategically designed G604 LIGHTSPEED Wireless Gaming Mouse. 15 programmable controls join forces with ultra-fast LIGHTSPEED dual connectivity and the class-leading HERO 25K sensor. </Text>
                    </View>
                </ScrollView>
                <View style={{height: 50, width: "100%",justifyContent:"center", padding:30,}}>
                    <Text style={styles.productHead}>{this.state.Price}</Text>
                    <Text style={styles.productHeadCount}>Tax Rate 2% - P89.95 (P6088.95)</Text>
                </View>
