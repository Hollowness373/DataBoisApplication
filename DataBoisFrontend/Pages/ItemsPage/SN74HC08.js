...
export default class SN74HC08 extends Component {
  constructor(props) {
    ...
    this.state = {
      ProductName:
        "10PCS SN74HC08N DIP14 SN74HC08 DIP 74HC08N 74HC08 DIP-14 new and original IC",
      ActualPrice: 324,
      Price: "P 324",
    };
  }
    ...
    return (
      <View style={styles.container}>
        <ScrollView showsVerticalScrollIndicator={false}>
          <ImageBackground
            source={require("../../assets/Product/74HC08.png")}
          ...
          <View style={{ height: 205, width: "100%", padding: 15 }}>
            ...
            <Text style={styles.productHeadCount}>
              The 74HC08 is identical in pinout to the LS08. The device inputs
              are compatible with Standard CMOS outputs; with pullup resistors,
              they are compatible with LSTTL outputs. Features. • Output Drive
              Capability: 10 LSTTL Loads. • Outputs Directly Interface to CMOS,
              NMOS and TTL.
            </Text>
          </View>
        </ScrollView>
